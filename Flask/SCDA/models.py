...
class IR(db.Model):
    ...
    def __init__(self, constituent_id, form_upload_date, case_number='', CAD_incident_num='', report_type='', date_time_occured='', date_time_reported='', public_narrative=''):
        self.constituent_id = constituent_id
        self.form_upload_date = form_upload_date
...
class CC(db.Model):
    ...
    def __init__(self, constituent_id, form_upload_date, docket_number='', full_name='', date_of_birth='', date_of_issued_complaint='', date_of_offense='',date_of_arrest='',next_event_date='',obtn_num='',incident_report_num='',court_address='',defendant_address='',offense_code=''):
        self.constituent_id = constituent_id
        self.form_upload_date = form_upload_date
...
class MF(db.Model):
    ...
    def __init__(self, constituent_id, form_upload_date, booking_name="",first="",middle="",suffix="",home_address="",report_date="",booking_status="",printed_by="",sex="",race="",date_of_birth="",district="",booking_num="",charges="",telephone_used="",breathalyzer_used="", examined_at_hospital="",examined_by_ems="",visibile_injuries="",money="",property_storage_num="",property=""):    
         self.booking_name =  booking_name
         self.first = first
         self.middle=middle
         self.suffix=suffix
...
class PR(db.Model):
    ...
    def __init__(self, constituent_id, form_upload_date="",pcf="",date_of_birth="",age="", birthplace="",mother="",father="",height="", weight="", hair="", eyes="", gender="", race="", ethnicity="", driver_license_num="", cari="",records_include=""):
        self.pcf=pcf
        self.date_of_birth=date_of_birth
        self.age=age
